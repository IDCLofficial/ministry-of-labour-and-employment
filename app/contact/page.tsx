                                ...
                                <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[0]}>
                                    <div className="hover:transform hover:scale-105 transition-transform duration-300">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <a href="mailto:commissioner.info@labour.im.gov" className="block text-blue-600 hover:text-blue-800 transition-colors duration-300">
                                                commissioner.info@labour.im.gov
                                            </a>
                                        </div>
                                    </div>
                                </AnimatedEntrance>
