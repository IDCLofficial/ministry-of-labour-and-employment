                                ...
                                <AnimatedEntrance {...ANIMATION_PRESETS.TEXT_FADE_LEFT} delay={200}>
                                    <div className="text-center md:text-left">
                                        ...
                                        <p className="max-w-lg opacity-70 text-sm sm:text-base leading-relaxed">
                                            Subscribe to our newsletter for the latest job openings, training programs, and employment news from the Ministry of Labour and Employment, Imo State.
                                        </p>
                                    </div>
                                </AnimatedEntrance>
                            ...
                            <div className="sm:col-span-2 md:col-span-1">
                                <Link href="/" className="group cursor-pointer">
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                                        ...
                                        <span className="text-base sm:text-lg md:text-xl font-bold flex-1 leading-tight transition-colors duration-300 group-hover:text-green-300">Ministry of Labour and Employment</span>
                                    </div>
                                </Link>
                                <p className="text-gray-300 leading-relaxed text-sm sm:text-base hover:text-gray-200 transition-colors duration-300">
                                    The Ministry of Labour and Employment is dedicated to creating employment opportunities, developing skills, and ensuring decent work for all citizens of Imo State through innovative programs and partnerships.
                                </p>
                            </div>
                        </AnimatedEntrance>
                        ...
                        <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[1]}>
                            <div>
                                ...
                                <ul className="space-y-2 sm:space-y-3">
                                    ...
                                    <li><Link href="/services" className="text-gray-300 hover:text-green-300 hover:translate-x-1 transition-all duration-300 text-sm sm:text-base inline-block">Projects</Link></li>
                        ...
                        <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[3]}>
                            <div>
                                ...
                                <div className="mt-4 sm:mt-6 space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-300 grid">
                                    <a href="tel:+2348030001111" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">+234 803 000 1111</a>
                                    <a href="tel:+2348022223333" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">+234 802 222 3333</a>
                                    <a href="mailto:info@imolabour.ng" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">info@imolabour.ng</a>
                                    ...
                                    <div className="flex space-x-4 mt-2">
                                        ...
                                        <a href="https://twitter.com/imolabour" target="_blank" rel="noopener noreferrer" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">
                                            Twitter
                                        </a>
